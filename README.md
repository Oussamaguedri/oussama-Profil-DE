...
<head>
  ...
  <meta name="description" content="Maschinenbauingenieur & Fertigung / Qualitätsingenieur. Verfügbar ab sofort. Standort: Hannover – deutschland, remote/onsite." />
...
<body class="bg-slate-50 text-slate-900">
  ...
  <img src="bwog-logo.png" alt="Oussama Guedri Logo" class="h-10 w-auto" />
</a>
    ...
    <div class="max-w-6xl mx-auto px-4 py-16 md:py-24 relative">
      <div class="grid lg:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <h1 class="text-3xl md:text-5xl font-extrabold leading-tight tracking-tight">Oussama Guedri<br><span class="text-blue-700"> Maschinenbau </span></h1>
          <p class="mt-5 text-slate-700 max-w-2xl">Industrieerfahrung in Antriebstechnik, Fertigung und Produktion. Fokus auf Simulation, Prozessoptimierung und Qualitätssicherung. Deutschland, Frankreich, Schweiz & Dubai – remote oder vor Ort.</p>
          <p class="mt-3 text-slate-800 font-semibold">Teilnahme an <span class="text-blue-700"> in verschiedenen Branchen.</p>
  ...
  <section id="leistungen" class="py-16 md:py-24">
    <div class="max-w-6xl mx-auto px-4">
      ...
      <p class="mt-3 text-slate-600 max-w-3xl">Ich übernehme die vollständige Verantwortung für den gesamten Prozess von der Anforderungsanalyse über die Auschreibung und Beschaffung bis zur Umsetzung und Nachverfolgung Transparent, wirkungsvoll und skalierbar.</p>
      <div class="mt-8 grid md:grid-cols-3 gap-6">
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md transition">
          <h3 class="font-bold text-lg">Simulation & Prozessoptimierung</h3>
          <ul class="mt-3 space-y-2 text-sm text-slate-700 list-disc list-inside">
            <li>FEM-Simulationen</li>
            <li>Analyse von Prozessparametern & Materialverhalten</li>
            <li>Automatisierung & Optimierung von Simulationsabläufen</li>
          </ul>
        </div>
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md transition">
          <h3 class="font-bold text-lg">Konstruktion & Fertigung</h3>
          <ul class="mt-3 space-y-2 text-sm text-slate-700 list-disc list-inside">
            <li>Konstruktion von Getriebekomponenten</li>
            <li>Zeichnungserstellung & Toleranzanalysen</li>
            <li>Produktionsunterstützung & Fertigungsprozesse</li>
          </ul>
        </div>
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md transition">
          <h3 class="font-bold text-lg">Qualität</h3>
          <ul class="mt-3 space-y-2 text-sm text-slate-700 list-disc list-inside">
            <li>Qualitätskontrolle & Prozessfähigkeitsanalysen</li>
            <li>Leiterplattenprüfung & Prototypenentwicklung </li>
            <li>Wärmebehandlung & Härteprozesse</li>
          </ul>
        </div>
      </div>
    </div>
...
<div id="logoScroller" class="logo-track mt-6 overflow-x-auto flex gap-4 snap-x">
  ...
  <div class="logo-card min-w-[200px] shrink-0 rounded-2xl border border-slate-200 bg-white p-4 flex flex-col items-center justify-center">
    <img src="bmw-logo.png" alt="BMW AG; Partner" class="h-12 object-contain mb-2" />
    <span class="text-sm font-medium text-slate-700">BMW AG</span>
  </div>
...
<div class="mt-12 grid md:grid-cols-3 gap-6">
  <!-- Projekt 1: Bachelorarbeit – Ringstauchversuch -->
  <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md transition">
    <img src="ringstauchversuch.png" alt="Simulation Ringstauchversuch – FEM-Analyse" class="h-24 object-contain mb-4 mx-auto" />
    <h3 class="font-bold text-lg text-center">Simulation Ringstauchversuch</h3>
    <p class="mt-3 text-sm text-slate-600 text-center">
      Durchführung von <strong>FEM-Simulationen</strong> zur Analyse des Materialverhaltens 
      im <strong>Ringstauchversuch</strong>. Vergleich manueller und automatisierter 
      Simulationen, Identifikation von Fehlerquellen und <strong>Optimierung der Prozessgestaltung</strong> 
      mit <strong>Simufact & Ansys</strong>.
    </p>
  </div>

  <!-- Projekt 2: BMW E-Getriebe -->
  <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md transition">
    <img src="bmw-getriebe.png" alt="BMW E-Getriebe Konstruktion & Toleranzmanagement" class="h-24 object-contain mb-4 mx-auto" />
    <h3 class="font-bold text-lg text-center">BMW E-Getriebe – Konstruktion</h3>
    <p class="mt-3 text-sm text-slate-600 text-center">
      Unterstützung bei der <strong>Konstruktion von Getriebekomponenten</strong> 
      mit <strong>CATIA V5</strong>. Erstellung von Zeichnungen, Toleranzanalysen 
      und <strong>Zusammenbauuntersuchungen</strong>. Analyse der Montageprozesse 
      im BMW Werk Dingolfing.
    </p>
  </div>

  <!-- Projekt 3: Volkswagen Produktion -->
  <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md transition">
    <img src="vw-produktion.png" alt="VW Produktion – Fertigungsunterstützung" class="h-24 object-contain mb-4 mx-auto" />
    <h3 class="font-bold text-lg text-center">Volkswagen – Produktion</h3>
    <p class="mt-3 text-sm text-slate-600 text-center">
      Tätigkeit als <strong>studentische Hilfskraft</strong> im Bereich 
      <strong>Produktion & Fertigung</strong>. Unterstützung bei 
      <strong>Prozessabläufen</strong>, Dokumentation und Mitarbeit in der Serienproduktion.
    </p>
  </div>

  <!-- Projekt 4: Leiterplattenfertigung ILFA -->
  <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md transition">
    <img src="ilfa-leiterplatten.png" alt="ILFA – Leiterplattenfertigung & Qualitätskontrolle" class="h-24 object-contain mb-4 mx-auto" />
    <h3 class="font-bold text-lg text-center">ILFA – Leiterplattenfertigung</h3>
    <p class="mt-3 text-sm text-slate-600 text-center">
      Mitarbeit in der <strong>Leiterplattenproduktion</strong>, 
      <strong>Qualitätskontrolle & Sichtprüfung</strong> sowie 
      Unterstützung bei <strong>Prototypenentwicklung</strong>. 
      Maschinenbedienung, Wartung und Prozessdokumentation.
    </p>
  </div>

  <!-- Projekt 5: Hanomag – Wärmebehandlung -->
  <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md transition">
    <img src="hanomag-haerterei.png" alt="Hanomag – Härterei & Prozesssicherheit" class="h-24 object-contain mb-4 mx-auto" />
    <h3 class="font-bold text-lg text-center">Hanomag – Wärmebehandlung</h3>
    <p class="mt-3 text-sm text-slate-600 text-center">
      Einführung in die <strong>Wärmebehandlung von Werkstoffen</strong>. 
      Überwachung von <strong>Temperaturprofilen & Prozessparametern</strong>, 
      Durchführung von Stichprobenprüfungen zur <strong>Qualitätssicherung</strong> 
  ...
  <div class="max-w-6xl mx-auto px-4">
    <h2 class="text-2xl md:text-3xl font-extrabold tracking-tight">Skills</h2>
    <div class="mt-8 grid md:grid-cols-2 gap-6">
      ...
      <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <ul class="mt-3 grid grid-cols-2 gap-2 text-sm text-slate-700">
          <li>CAD-Konstruktion (Solid Edge, CATIA V5)</li>
          <li>Simulation & FEM (Simufact, Ansys, Matlab)</li>
          <li>Prozessauslegung & -optimierung</li>
          <li>Qualitätssicherung & Toleranzmanagement</li>
          <li>Produktionsunterstützung & Fertigung</li>
          <li>Werkstofftechnik & Wärmebehandlung</li>
          <li>Projektarbeit & Dokumentation</li>
        </ul>
      </div>
